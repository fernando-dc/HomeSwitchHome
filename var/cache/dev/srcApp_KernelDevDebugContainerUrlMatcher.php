...
class srcApp_KernelDevDebugContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function __construct(RequestContext $context)
    {
        ...
        $this->staticRoutes = [
            ...
            '/login' => [[['_route' => 'app_login_user', '_controller' => 'App\\Controller\\SecurityController::loginUser'], null, null, null, false, false, null]],
        ...
        $this->dynamicRoutes = [
            ...
            245 => [[['_route' => 'subastas_participar', '_controller' => 'App\\Controller\\SubastasController::participarDeSubasta'], ['id'], null, null, false, true, null]],
        ];
    }
}
